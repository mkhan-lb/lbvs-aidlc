...
- Task agents come from `.omp/agents/` (`lbvs-aidlc-verifier`, `lbvs-aidlc-repo-scout`); each defers to its `.claude/agents/` definition. omp does not read `.claude/agents/` directly.
