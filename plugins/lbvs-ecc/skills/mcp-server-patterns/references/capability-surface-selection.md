> **AIDLC integration:** This bundled ECC reference preserves upstream design guidance and packaging policy for context; it does not replace AIDLC conventions or authorize new rules, hooks, installers, servers, or remote API actions. Follow the [AIDLC skill-library guidance](../../../../docs/USAGE.md#12-use-the-optional-ecc-skill-library); discover available capabilities and obtain applicable write authority separately from reads.
