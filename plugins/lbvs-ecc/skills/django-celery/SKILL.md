...
**Execution scope:** Confirm the selected environment and available tools before using these examples. Worker or Beat startup can consume live tasks, send messages, charge payments, or change records; it needs explicit authority for those effects. Broker inspection is separate from enqueueing tasks, changing schedules, starting workers, or installing packages. If the required tool is unavailable, stop that operation rather than installing it automatically.
...
- Optional upstream-only [django-patterns](https://github.com/affaan-m/ECC/blob/8321021c54d670126ce3b2969d5deb880b4b0c2a/skills/django-patterns/SKILL.md) — ORM, service layer, and project structure; not installed by this bundle.
- Optional upstream-only [django-tdd](https://github.com/affaan-m/ECC/blob/8321021c54d670126ce3b2969d5deb880b4b0c2a/skills/django-tdd/SKILL.md) — Testing Django models, views, and services; not installed by this bundle.
- [python-testing](../python-testing/SKILL.md) — pytest configuration and fixtures
