...
shape; use [api-design](../api-design/SKILL.md) for the HTTP contract and the included [security-review](../security-review/SKILL.md) guidance for abuse cases. A skill is not a separately registered reviewer agent.
