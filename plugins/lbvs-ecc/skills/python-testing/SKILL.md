...
The TDD workflow and coverage targets below are upstream reference practices, not new AIDLC gates. Follow the project’s agreed verification strategy; selecting this reference does not authorize installing test tools, changing CI, or creating tests solely to meet an illustrative percentage.
