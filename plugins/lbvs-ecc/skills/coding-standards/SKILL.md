...
- Use [bundled common coding style](references/rules/common/coding-style.md) when you need the shortest reusable rule layer instead of a full skill walkthrough.
