...
Keep the existing component test conventions; introduce another runner only for an explicitly agreed separate testing lane.
...
For those, use Playwright Component Testing or end-to-end Playwright/Cypress runs. See [e2e-testing skill](../../../../e2e-testing/SKILL.md).

## Illustrative Coverage Targets

Existing app coverage policy takes precedence; do not change CI or thresholds merely by loading this reference.
...
See [react-testing skill](../../../SKILL.md) for end-to-end test examples, MSW patterns, and accessibility test scaffolding.
