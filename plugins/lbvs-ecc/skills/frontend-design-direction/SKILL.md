...
`frontend-design` skill. The official skill in [anthropics/skills](https://github.com/anthropics/skills) is a separate optional upstream resource, not installed or required here; installing it requires a separate request. This skill is the ECC-specific design-direction salvage
