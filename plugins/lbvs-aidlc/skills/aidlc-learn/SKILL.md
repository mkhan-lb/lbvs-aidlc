...
Sources: CE 3.26.3 contract links in ${CLAUDE_PLUGIN_ROOT}/docs/WORKFLOW.md; [AI-native SDLC playbook](https://claude.com/blog/the-ai-native-sdlc-playbook) X01.
