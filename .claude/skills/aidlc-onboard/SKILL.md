...
Read the `AIDLC project mode:` line from session context, or run `python3 scripts/aidlc.py mode`. If `.aidlc/mode` and `docs/onboarding.md` already exist, summarise the recorded decision and ask whether to refresh it before doing any scouting.
