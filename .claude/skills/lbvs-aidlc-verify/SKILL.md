...
1. Read `CLAUDE.md`, `REVIEW.md`, the [review template](../lbvs-aidlc-review/templates/review.md), and `changes/<change-id>/intent.md`, `spec.md` and `plan.md`. Inspect the implementation/diff, relevant tests and command definitions. Identify the revision or working-tree state being checked.
