...
Contract: docs/WORKFLOW.md ([Compare directions before intent](../../../docs/WORKFLOW.md#compare-directions-before-intent)). Paths are repository-root relative; bundled files are relative to this skill directory.
