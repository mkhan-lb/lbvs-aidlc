...
1. Read `CLAUDE.md`, `REVIEW.md`, existing same-change intent/spec/plan and relevant current code or working-tree changes. A bounded direct request may supply missing upstream context; name gaps, never invent files.
