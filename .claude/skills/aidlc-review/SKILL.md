...
1. Read `CLAUDE.md`, `REVIEW.md`, both bundled resources, and available `changes/<change-id>/intent.md`, `spec.md`, `plan.md`, prior `review.md` and verification record. Report missing context; never invent approvals, requirements or evidence.
