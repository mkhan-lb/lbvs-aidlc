...
- Consulted files (sha256 at the pinned commit):
  - `core/agents/aidlc-architecture-reviewer-agent.md` — `69efa6bdaddc9c439860e584efd7f48429d8c88157bdadb25193eb6a16aeddcd` → adapted into `.claude/agents/aidlc-design-reviewer.md`
  - `core/agents/aidlc-devsecops-agent.md` — `8abba85622c5556350935d138bfec616edbfb86e8ac3e3095a965d4e80b8962b` → adapted into `.claude/agents/aidlc-threat-modeler.md`
...
The `.claude/agents/aidlc-threat-modeler.md` "Do not flag" list is additionally adapted from `agents/security-reviewer.md` in affaan-m/ECC at commit `8321021c54d670126ce3b2969d5deb880b4b0c2a` (MIT). That repository's copyright and permission notice is already retained at [`../ecc/LICENSE`](../ecc/LICENSE) and its pin is recorded in [`../ecc/manifest.json`](../ecc/manifest.json); no separate copy is needed here.
