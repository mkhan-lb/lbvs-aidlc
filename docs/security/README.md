...
- `patches/` is not a folder: a security fix is an ordinary `/aidlc-fix` change whose `evidence.md` links the finding here and the incident record when there was one.
